		...
		<div className={mystyle.cardBody}> 
			...
			<div className="card-text">
				<form className={mystyle.form}>
					...
					<p className="mt-1 align-center" style={{marginBottom: '0px', textAlign:'center'}}><a _ngcontent-gwq-c42="" className="mail-link" href="mailto:gold365info@gmail.com">gold365info@gmail.com</a></p>
